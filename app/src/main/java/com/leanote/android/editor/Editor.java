...
public abstract class Editor {
    ...
    protected class EditorClient extends WebViewClient {
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
            ...
            LogUtils.i(TAG + "shouldInterceptRequest(), request=" + url + ", scheme=" + uri.getScheme() + ", authority=" + uri.getAuthority());
//            if (NoteFileService.isLocalImageUri(uri)) {
//                LogUtils.i(TAG + "get image");
...
//            }
        ...
        public void onLoadResource(WebView view, String url) {
            ...
            LogUtils.i(TAG + "onLoadResource(), rul=" + url);
        }
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            LogUtils.i(TAG + "onReceivedError(), code=" + errorCode + ", desc=" + description + ", url=" + failingUrl);
        }
    }
    ...
    protected class EditorChromeClient extends WebChromeClient {
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            LogUtils.i(TAG + String.format("source=%s, line=%d, msg=%s",
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            LogUtils.i(TAG + "alert: url=" + url + ", msg=" + message);
            return true;
        }
    }
}
